...
const solutions = [
  ...
  },
  {
    ...
    subtitle: "Revêtement à l'aérogel de silice",
    description:
      "ThermicRoof est un revêtement à base d'aérogel de silice qui agit sur deux fronts : il renvoie le rayonnement solaire en surface et freine la conduction de la chaleur dans son épaisseur. Une seule application, une barrière thermique complète pour toiture, façade et industrie.",
    advantages: [
      "-7°C à l'intérieur l'été",
      "85% de réflexion solaire · émissivité 91%",
      'SRI 110 (ASTM E1980) · λ 0,0955 W/m·K',
      "Sans gros œuvre — pistolet Airless ou rouleau",
      'FDES certifié INIES · 25% de contenu recyclé',
    ],
    applications: ['Toitures industrielles', 'Façades', 'Entrepôts', 'Bâtiments tertiaires', 'Copropriétés'],
